...
func Test_Collection_CBOR_Deserialize_ok(t *testing.T) {
	...
	assert.Equal(t, CBORArray, one.GetForm())
	...
	assert.Equal(t, CBORTag, two.GetForm())
	...
	assert.Equal(t, CBORArray, s.GetForm())
}
